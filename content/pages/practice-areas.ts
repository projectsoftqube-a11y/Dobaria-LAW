...
export const practiceAreasHub = {
  ...
  trustBand: ["45+ Years of Counsel", "50+ Countries Served", "8 Languages Spoken", "Admitted in PA, NJ & NY"],
  helper: {
    h2: "Not sure which area fits your situation?",
    body: "Many matters cross more than one practice area — an immigration case can involve family law, and a business can raise real estate questions. If you're unsure where you fit, start with a consultation and we'll point you in the right direction.",
  ...
  faqs: [
    ...
    { q: "What languages does the firm speak?", a: "English, Spanish, Gujarati, Hindi, German, Arabic, French, and Korean." },
    { q: "How do I know which practice area I need?", a: "You don't have to know. Book an initial consultation and we'll identify the right approach — including where a matter spans more than one area." },
  ],
  finalCta: {
    h2: "Begin with a consultation",
