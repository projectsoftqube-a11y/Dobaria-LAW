...
export const whyChooseUsContent = {
  ...
  differentiators: [
    ...
    { title: "A truly global practice", body: "We have represented clients from more than 50 countries, and six languages are spoken in-house. For people navigating an unfamiliar legal system, being understood in your own language is not a convenience — it is the difference between guessing and knowing." },
  ...
  credentialsBand: ["45+ Years", "U.S. Supreme Court Admitted", "AILA Members 28+ Years", "Clients from 50+ Countries", "6 Languages", "Admitted in PA, NJ & NY"],
  crossPractice: {
  ...
  commitment: {
    ...
    body: [
      "Every engagement starts with a free, confidential consultation and an honest read of your options — including the realistic timeline and the likely cost. We would rather set accurate expectations at the outset than promise an outcome no one can guarantee.",
  ...
  multilingual: {
    ...
    body: "We speak English, Spanish, German, Arabic, French, and Korean — because understanding your situation starts with understanding you.",
  ...
  faqs: [
    ...
    { q: "What languages do you speak?", a: "We speak six languages in-house: English, Spanish, German, Arabic, French, and Korean. Se habla español." },
