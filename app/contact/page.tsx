                  ...
                  <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex flex-col gap-1.5">
                        ...
                        />
                        {errors.firstName && <p id="contact-page-firstName-error" role="alert" className="text-red-500 text-[12px]">{errors.firstName}</p>}
                      </div>
                      <div className="flex flex-col gap-1.5">
                        ...
                        />
                        {errors.lastName && <p id="contact-page-lastName-error" role="alert" className="text-red-500 text-[12px]">{errors.lastName}</p>}
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="flex flex-col gap-1.5">
                        ...
                        />
                        {errors.email && <p id="contact-page-email-error" role="alert" className="text-red-500 text-[12px]">{errors.email}</p>}
                      </div>
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        />
                        {errors.phone && <p id="contact-page-phone-error" role="alert" className="text-red-500 text-[12px]">{errors.phone}</p>}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      {errors.practice && <p id="contact-page-practice-error" role="alert" className="text-red-500 text-[12px]">{errors.practice}</p>}
                    </div>
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      />
                      {errors.message && <p id="contact-page-message-error" role="alert" className="text-red-500 text-[12px]">{errors.message}</p>}
                    </div>
