...
import { whyChooseUsContent } from "@/content/pages/why-choose-us";
...
export default function WhyChooseUsClient() {
  const tu = useTranslations("whyChooseUsUI");
  const locale = useLocale() as "en" | "es";
  const content = whyChooseUsContent[locale];
        ...
        <div className="site-container relative z-10">
          <div className="grid lg:grid-cols-[420px_1fr] gap-12 lg:gap-20 items-start">
            ...
            <div className="lg:sticky lg:top-28">
              ...
              >
                {tu('experienceIt')} <ArrowRight size={13} />
              </Link>
            </div>
