...
export default function NotFoundClient() {
  ...
  // Built inside the component so the labels resolve in the active locale.
  const popularLinks = [
    { label: tn("immigrationLaw"), href: "/practice-areas/immigration-law", hint: tn("immigrationDesc"), icon: Plane },
    { label: tn("greenCards"), href: "/practice-areas/green-cards-visas", hint: tn("greenCardsDesc"), icon: IdCard },
    { label: tn("familyLaw"), href: "/practice-areas/family-law", hint: tn("familyDesc"), icon: Users },
    { label: tn("ourAttorneys"), href: "/attorneys", hint: tn("meetTeam"), icon: UserSquare2 },
    { label: tn("clientResults"), href: "/results", hint: tn("outcomesSecured"), icon: Award },
    { label: tn("scheduleConsultation"), href: "/schedule-consultation", hint: tn("talkToUs"), icon: CalendarCheck },
  ];
