...
export default function PracticeAreaClient({ data }: { data: PracticeData }) {
  const tp = useTranslations("practiceDetail");
  // Built inside the component so the copy resolves in the active locale.
  const heroBadges = [
    tp("badgeYears"),
    tp("badgeAila"),
    tp("badgeAdmitted"),
  ...
  const whyUsPoints = [
    { title: tp("why1Title"), body: tp("why1Body") },
    { title: tp("why2Title"), body: tp("why2Body") },
    { title: tp("why3Title"), body: tp("why3Body") },
    { title: tp("why4Title"), body: tp("why4Body") },
  ];
      ...
      <main className="min-h-screen bg-[#F8F6F2]">
        ...
        <section className="relative pt-32 pb-24 lg:pt-44 lg:pb-32 overflow-hidden bg-gradient-to-b from-[#0B0F17] to-[#1A2435]">
          ...
          <div className="relative z-10 site-container">
            ...
            >
              ...
              >
                {tp('scheduleConsultation')} <ArrowRight size={14} />
              </Link>
              <a
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-[11px]">{tp('trustedBadge')}</p>
                      </div>
                    </div>
                    ...
                    <div className="mt-7 pt-6 border-t border-white/10">
                      ...
                      >
                        {tp('scheduleConsultation')} <ArrowRight size={13} />
                      </Link>
                    </div>
                  </div>
                </div>
        ...
        <section className="site-section bg-gradient-to-br from-[#0B0F17] to-[#1B1E49] relative overflow-hidden">
          ...
          <div className="relative z-10 site-container">
            <div className="flex items-center gap-4 mb-10">
              <span className="w-8 h-[1px] bg-[#C29A3E]" />
              <span className="text-[#C29A3E] text-[11px] font-semibold tracking-[0.25em] uppercase">{tp('whyEyebrow')}</span>
            ...
            <div className="grid lg:grid-cols-[420px_1fr] gap-12 lg:gap-20 items-start">
              ...
              <div className="lg:sticky lg:top-28">
                ...
                >
                  {tp('moreReasons')} <ArrowRight size={13} />
                </Link>
              </div>
              {/* Right points */}
