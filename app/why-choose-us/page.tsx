...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://dobarialaw.com/why-choose-us",
  },
  openGraph: {
    title: "Why Choose Dobaria Law PC | Immigration, PA",
    description: "45+ years, eight languages, clients from 50+ countries, and attorneys admitted to the U.S. Supreme Court. See why clients choose Dobaria Law PC.",
