...
export default function PracticeAreasPage() {
  const { hero, intro, groups, trustBand, helper, faqs, finalCta } = practiceAreasHub;
        ...
        <div className="site-container">
          <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              >
                A Focused Practice Built on Four Decades of Trust
              </h2>
          ...
          <div className="grid lg:grid-cols-[340px_1fr] gap-12 items-start">
            ...
            <div className="lg:sticky lg:top-28">
              ...
              <p className="text-[#6B7280] text-[15px] leading-relaxed">
                Answers to the questions we hear most often about our practice and how we can help.
              </p>
            </div>
